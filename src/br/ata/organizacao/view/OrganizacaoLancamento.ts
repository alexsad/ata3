import {IOrganizacaoLancamento} from "../model/IOrganizacaoLancamento";
...
class OrganizacaoLancamento extends ModWindow{
	...
	mainList:ListView;
	constructor(){
		super("*lancamento de valores por organizacao","br.ata.organizacao.view.OrganizacaoLancamento");
		this.setRevision("$Revision: 138 $");
		this.setSize(8);

		this.mainTb = new ToolBar({"domain":"trimestre/organizacaolancamento"});
	...
	getByIdTrimestre(p_idTrimestre:any):void{
		...
		RequestManager.addRequest({
			...
			,"onLoad":function(dta:IOrganizacaoLancamento[]){
