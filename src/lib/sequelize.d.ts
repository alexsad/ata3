...
declare module SequelizeModule
{
    ...
    export interface SequelizeStatic extends SequelizeStaticAndInstance, DataTypes {
        /**
    ...
    export interface Sequelize extends SequelizeStaticAndInstance {
        /**
    ...
    export interface Model<TInstance, TPojo> extends Hooks, Associations {
        /**
    ...
    export interface Instance<TInstance, TPojo> {
        /**
    ...
    export interface Migration extends QueryInterface {
        migrator:Migrator;
        path:string;
        filename:string;
        migrationId:number;
    ...
    export interface CopyOptions extends BuildOptions {
        /**
    ...
    export interface FindOrCreateOptions extends FindOptions, QueryOptions {
    ...
    export interface HashToWhereConditionsOption
    {
        include?:boolean;
        keysEscaped?:boolean;
    }

    export interface ModelMangerGetDaoOptions {
        attribute:string;
    }

    export interface ModelManagerForEachDaoOptions {
        /**
         * Default true.
         */
        reverse:boolean;
    ...
    export interface QueryChainerRunSeriallyOptions {
        /**
    ...
    export interface MigratorExecOptions {
    ...
    export interface PromiseT<T> extends Promise {
        /**
         * Listen for events, event emitter style. Mostly for backwards compatibility with EventEmitter.
         *
         * @param evt Event
    ...
    export interface MetaPojo {
        from: string;
        to: string;
    }
    export interface MetaInstance extends MetaPojo, Model<MetaInstance, MetaPojo> {

    }

    export interface DataTypeStringBase {
        BINARY:DataTypeString;
    }
    export interface DataTypeNumberBase {
        UNSIGNED:boolean;
        ZEROFILL:boolean;
    }

    export interface DataTypeString extends DataTypeStringBase {
    }
    export interface DataTypeChar extends DataTypeStringBase {
    }
    export interface DataTypeInteger extends DataTypeNumberBase {
    }
    export interface DataTypeBigInt extends DataTypeNumberBase {
    }
    export interface DataTypeFloat extends DataTypeNumberBase {
    }
    ...
    export interface DataTypeVirtual {
    }
    ...
    export interface DataTypeHstore {
    }
...
declare module "sequelize" {
    var _s: SequelizeModule.SequelizeStatic;
    export = _s;
}
