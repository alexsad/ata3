...
export declare class Tab extends AContainer {
    ...
    prepend(p_button: LinkButton, p_childtoappend: Box | Painel, p_show_on_append?: boolean): void;
    append(p_button: LinkButton, p_childtoappend: Box | Painel, p_show_on_append?: boolean): void;
